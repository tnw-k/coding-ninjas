  ...
  return (isClient &&
    <section className='w-full h-screen '>
        ...
        <div 
            ...
            <div className="">
                <h1 className="title-animation title-outline bg-gradient-to-br from-orange-200 via-[#ff7f29] to-[#fe6702] bg-clip-text text-transparent outline-2 cursor-default red-hat-display-heading font-semibold text-7xl mb-10">
