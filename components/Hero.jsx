...
const Hero = () => {
  ...
  return (isClient &&
    <section className='w-full h-screen '>
        ...
        <div 
            className="  w-full z-20 xl:px-40 px-10 h-screen absolute text-center flex-col gap-6 top-0 flex justify-center items-center ">
            <div className="">
              ...
              <h1 
                className="title-animation title-outline bg-gradient-to-br from-orange-200 via-[#ff7f29] to-[#fe6702] bg-clip-text cursor-default red-hat-display-heading font-semibold sm:text-7xl text-6xl relative" 
            ...
            <p className="text-opacity-60 text-xl text-white cursor-default sm:mx-20 lg:mx-52">Empowering students to have fun while learning, coding, and developing together across diverse tech and creative domains.</p>
